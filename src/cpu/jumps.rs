...
pub fn eval_packed_branch<P: PackedField>(
    ...
    let aux1 = lv.mem_channels[2].value[0]; // src1 - src2
    let aux2 = lv.mem_channels[3].value[0]; // src2 - src1
    let aux3 = lv.mem_channels[4].value[0]; // (src1 ^ src2) & 0x80000000 > 0
    let aux4 = lv.mem_channels[5].value[0]; // branch offset
...
pub fn eval_packed_condmov<P: PackedField>(
    ...
    let mov = lv.mem_channels[4].value[0]; // mov rs to rd
